...
function deleteAny() {
    var startingIndex = Number(prompt("Which number do you want to start deleting from"))
    var numberOfItems = Number(prompt("Enter number of items you want to delete"))
